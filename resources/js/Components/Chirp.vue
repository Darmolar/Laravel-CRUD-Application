            ...
            <div class="flex justify-between items-center">
                ...
                <Dropdown v-if="chirp.user.id === $page.props.auth.user.id">
                    ...
                    <template #content>
                        ...
                        <DropdownLink as="button" @click="form.delete(route('chirps.destroy', chirp.id), { onSuccess: () => {} })" class="block w-full px-4 py-2 text-left text-sm leading-5 text-red-700 hover:bg-red-100 focus:bg-red-100 transition duration-150 ease-in-out">
                            Delete
                        </DropdownLink>
                    </template>
                </Dropdown>
